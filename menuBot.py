...
m_games = Menu("Игры", buttons=["Камень, ножницы, бумага", "КНБ Multiplayer", "Игра в 21", "Угадай кто?","Угадай число", "Выход"], parent=m_main)
...
m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6", "Задание-7", "Выход"], parent=m_main)
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать анекдот",  "Прислать новости", "Прислать фильм", "Прислать котика","Прислать гуля","Прислать аниме","Прислать рандом картинку", "Выход"], parent=m_main)
